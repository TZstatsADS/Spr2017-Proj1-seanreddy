...
to identify important themes of the speeches allowing us to find the most representative sentences within a given speech. To illustrate this tool, we will be analyzing the presidential address by Donald J. Trump in the notebook below.
...
*Please note that each theme is not necessarily a word present in the speech at all, as it may merely be a synonym of two or more words present in the speech that encapsulates the definition of both or all of them*
